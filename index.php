...
?>
        ...
        <div id="slider-principal" class="carousel slide mt-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item">
                    <img src="img/slide_02.jpg" alt="Conoce nuestros servicios" class="">
                    <div class="carousel-caption">
                ...
                <div class="carousel-item">
                    <img src="img/slide_03.jpg" alt="Promoción" class="">
                    <div class="carousel-caption">
    ...
    <section class="nuevo-sitio py-5">
        ...
        <p class="text-center mt-4">Te sentirás como nuevo nuevo(a) con nuestros <br> masajistas profesionales</p>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 p-4">
                    ...
                    <p class="text-center lead mt-3 lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam, eaque molestias aliquid, minima praesentium deleniti quaerat debitis perferendis magnam aliquam dolor aperiam non at, consequatur illum fugit impedit. Labore, voluptatibus.</p>
                ...
                <div class="card">
                    <a href="producto.php?id=<?php echo $producto['id']; ?>">
                        ...
                        <div class="card-body">
                            ...
                            <p class="precio lead mb-0 text-center">
